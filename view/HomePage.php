...
<body class="font-inter">
    ...
    <main class="flex flex-col items-center w-full px-10">
        ...
        <div class="w-1/2 border-black border-2 h-10 my-10 flex justify-between items-center px-2">
            <input type="search" class="h-full px-2 flex-1">
        ...
        <div class="flex flex-col items-start w-full">
            ...
            <div class="grid grid-cols-5 gap-10 mt-10 w-full text-white text-center">
                ...
                foreach ($data as $item) {
                    $nama_tempat = "Nama Tempat " . $item; // Mengatur nama tempat sesuai dengan data
                    require 'card.php'; // Memanggil file card.php dengan data yang diberikan
                }
                ?>
            </div>
        </div>
